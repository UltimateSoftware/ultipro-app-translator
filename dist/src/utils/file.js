...
// Regex to strip .json from filename
exports.extractTag = /\/?([^\/]*)\.json/;
...
function createDirectoryIfNotExist(dir) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, exports.access(dir).catch(function (err) {
                    if (err.code === 'ENOENT') {
...
function getJSONFilesInDir(langDir) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, globAsync('*.json', { cwd: langDir })];
        });
    });
}
exports.getJSONFilesInDir = getJSONFilesInDir;
function getCSVFilesInDir(langDir) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, globAsync('*.csv', { cwd: langDir })];
        });
    });
}
exports.getCSVFilesInDir = getCSVFilesInDir;
